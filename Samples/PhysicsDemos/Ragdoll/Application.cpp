...
void Application::Setup() {
    ...
    bodyTextures.Set(leftArm, "../Content/ragdoll/leftArm.png");
    bodyTextures.Set(rightArm, "../Content/ragdoll/rightArm.png");
    bodyTextures.Set(leftLeg, "../Content/ragdoll/leftLeg.png");
    bodyTextures.Set(rightLeg, "../Content/ragdoll/rightLeg.png");
    world->AddBody(bob);
    world->AddBody(head);
    world->AddBody(torso);
        ...
        switch (event.type) 
        {
            ...
            case SDL_MOUSEBUTTONDOWN:
                if (event.button.button == SDL_BUTTON_LEFT) 
                {
                    ...
                    bodyTextures.Set(ball, "../Content/basketball.png");
                ...
                if (event.button.button == SDL_BUTTON_RIGHT) 
                {
                    ...
                    bodyTextures.Set(box, "../Content/crate.png");
                    box->restitution = 0.2;
                    world->AddBody(box);
                }
                break;
...
void Application::Render() {
    ...
    diagnosticsData.sampleName = "RagdollApp";
    diagnosticsData.world = world;
    diagnosticsData.debugDraw = debug;
    diagnosticsData.controls = "D debug, mouse moves anchor, LMB ball, RMB box, Esc quit";
