...
{
	uint32 firstLayerMask = EnginePhysicsCollision::All;
	uint32 secondLayerMask = EnginePhysicsCollision::All;
...
private:
	...
	bool LayerMatches(Entity entity, uint32 layerMask) const
	{
