...
///////////////////////////////////////////////////////////////////////////////
// FVectorN with the all linear and angular velocities of bodies "a" and "b"
///////////////////////////////////////////////////////////////////////////////
//  [ va.x ]
//  [ va.y ]
//  [ ωa   ]
...
//  [ ωb   ]
///////////////////////////////////////////////////////////////////////////////
AE::Math::FVectorN Constraint::GetVelocities() const
{
	AE::Math::FVectorN V(6);
	V.Zero();
	V[0] = a->velocity.X;
	V[1] = a->velocity.Y;
...
void JointConstraint::Solve()
{
	...
	const AE::Math::FVectorN impulses = Jt * lambda;
